...
def _gen_dst_id( pattern, nports, src_id ):
  if pattern == 'urandom':
    ...
    return bitReverse(src_id, nports)
  elif pattern == 'bit-rotation':
    return bitRotation(src_id, nports)
  elif pattern == 'shuffle':
    return shuffle(src_id, nports)
  elif pattern == 'transpose':
    return transpose(src_id, nports)
  elif pattern == 'neighbor':
    return neighbor(src_id, nports)
  elif pattern == 'tornado':
    return tornado(src_id, nports)
  else:
